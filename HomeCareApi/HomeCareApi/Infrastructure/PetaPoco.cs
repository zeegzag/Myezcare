...
namespace PetaPoco
{
    ...
    public partial class Database : IDisposable
    {
        ...
        public Database(MyEzcareOrganization organization)
        {
            string connectionstring = string.Empty;
            string providerName = string.Empty;
            connectionstring = string.Format("Server={0};Database={1}; User ID={2};Password={3}", organization.DBServer, organization.DBName, organization.DBUserName, organization.DBPassword);

            if (!string.IsNullOrEmpty(organization.DBProviderName))
                providerName = organization.DBProviderName;
            else
        ...
        private void CommonConstruct()
        {
            ...
            // Resolve the DB Type
            string DBTypeName = (_factory == null
                                     ? _sharedConnection.GetType()
        ...
        private void AddParam(IDbCommand cmd, object value, PropertyInfo pi)
        {
            ...
            else
            {
                ...
                else if (t == typeof (string))
                {
                    ...
                    if ((value as string).Length + 1 > 4000 && p.GetType()
                                                                .Name == "SqlCeParameter")
                        p.GetType()
                         .GetProperty("SqlDbType")
                         .SetValue(p, SqlDbType.NText, null);
                ...
                else if (t == typeof (AnsiString))
                {
                    ...
                    p.DbType = DbType.AnsiString;
                              ...
                              .Name == "SqlGeography") //SqlGeography is a CLR Type
                {
                    p.GetType()
                    ...
                    p.Value = value;
                              ...
                              .Name == "SqlGeometry") //SqlGeometry is a CLR Type
                {
                    p.GetType()
                     .GetProperty("UdtTypeName")
            ...
            try
            {
                ...
                try
                {
                    using (var cmd = CreateCommand(_sharedConnection, sql, args))
                    {
                        ...
                        return (T) Convert.ChangeType(val, u == null
                                                               ? typeof (T)
                                                               : u);
                    }
                }
        ...
        {
            var poco = PocoData.ForType(typeof (T))
                               .TableInfo;
        ...
        {
            return Exists<T>(string.Format("{0}=@0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof (T))
        ...
        {
            return Single<T>(string.Format("WHERE {0}=@0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof (T))
                                                                                               .TableInfo.PrimaryKey)), primaryKey);
        }
        ...
        {
            return SingleOrDefault<T>(string.Format("WHERE {0}=@0", _dbType.EscapeSqlIdentifier(PocoData.ForType(typeof (T))
                                                                                                        .TableInfo.PrimaryKey)), primaryKey);
        }
        ...
        public void BulkInsertRecords<T>(IEnumerable<T> collection)
        {
            try
            {
                ...
                using (var cmd = CreateCommand(_sharedConnection, ""))
                {
                    ...
                    string cols = string.Join(", ", (from c in pd.QueryColumns
                                                     select tableName + "." + _dbType.EscapeSqlIdentifier(c)).ToArray());
                    ...
                    foreach (var poco in collection)
                    {
                        ...
                        {
                            values.Add(string.Format("{0}{1}", _paramPrefix, index++));
                            AddParam(cmd, i.Value.GetValue(poco), pd.Columns[pd.TableInfo.PrimaryKey].PropertyInfo);
                        }
        ...
        /// <summary>
        /// Data base provider from DatabaseProviderValue enum
        /// </summary>
        public int DatabaseProvider { get; set; }

        public enum DatabaseProviderValue
        {
            MSSQL = 1,
            MYSQL
        }
    ...
    */
    ...
    public class ColumnInfo
    {
        ...
        public static ColumnInfo FromProperty(PropertyInfo pi)
        {
            ...
            bool ExplicitColumns = pi.DeclaringType.GetCustomAttributes(typeof (ExplicitColumnsAttribute), true)
                                     .Length > 0;
            ...
            {
                if (pi.GetCustomAttributes(typeof (IgnoreAttribute), true)
                      .Length != 0)
                    return null;
            }
            ...
            if (ColAttrs.Length > 0)
            {
                ...
                ci.ColumnName = colattr.Name == null
                                    ? pi.Name
                                    : colattr.Name;
    ...
    public static class Mappers
    {
        ...
        public static void Revoke(IMapper mapper)
        {
            ...
            try
            {
                foreach (var i in _mappers.Where(kvp => kvp.Value == mapper)
                                          .ToList())
    ...
    public class TableInfo
    {
        ...
        public static TableInfo FromPoco(Type t)
        {
            ...
            ti.TableName = a.Length == 0
                               ? t.Name
                               : (a[0] as TableNameAttribute).Value;

            // Get the primary key
            a = t.GetCustomAttributes(typeof (PrimaryKeyAttribute), true);
            ti.PrimaryKey = a.Length == 0
                                ? "ID"
                                : (a[0] as PrimaryKeyAttribute).Value;
            ti.SequenceName = a.Length == 0
                                  ? null
                                  : (a[0] as PrimaryKeyAttribute).sequenceName;
            ti.AutoIncrement = a.Length == 0
                                   ? false
                                   : (a[0] as PrimaryKeyAttribute).autoIncrement;
    ...
    namespace Internal
    {
        ...
        internal class MultiPocoFactory
        {
                ...
                return AutoMappers.Get(key, () =>
                                            {
                                                ...
                                                for (int i = 1; i < types.Length; i++)
                                                {
                                                    ...
                                                    {
                                                        // Find the property
                                                        var candidates = from p in types[j].GetProperties()
                                                        ...
                                                        if (candidates.Count() > 1)
                                                            throw new InvalidOperationException(
                                                                string.Format("Can't auto join {0} as {1} has more than one property of type {0}", types[i],
                                                                    types[j]));

                                                        // Generate code
                                                        il.Emit(OpCodes.Ldarg_S, j);
                                                        il.Emit(OpCodes.Ldarg_S, i);
                                                        il.Emit(OpCodes.Callvirt, candidates.First()
                                                                                            .GetSetMethod(true));
                                                        handled = true;
                                                    }
                                                ...
                                                // Cache it
                                                return m.CreateDelegate(Expression.GetFuncType(types.Concat(types.Take(1))
                                                                                                    .ToArray()));
                                            }
                    );
            }
            ...
            private static Delegate FindSplitPoint(Type typeThis, Type typeNext, string ConnectionString, string sql, IDataReader r, ref int pos)
            {
                // Last?
                if (typeNext == null)
                    return PocoData.ForType(typeThis)
                                   .GetFactory(sql, ConnectionString, pos, r.FieldCount - pos, r);
            ...
            {
                var m = new DynamicMethod("petapoco_multipoco_factory", typeof (TRet), new Type[]
                                                                                       {
                                                                                           typeof (MultiPocoFactory), typeof (IDataReader), typeof (object)
                ...
                for (int i = 0; i < types.Length; i++)
                {
                    ...
                    var del = FindSplitPoint(types[i], i + 1 < types.Length
                                                           ? types[i + 1]
                                                           : null, ConnectionString, sql, r, ref pos);
                    dels.Add(del);
                ...
                il.Emit(OpCodes.Callvirt, Expression.GetFuncType(types.Concat(new Type[]
                                                                              {
                                                                                  typeof (TRet)
                                                                              })
                                                                      .ToArray())
        ...
        internal class PocoData
        {
            ...
            public Delegate GetFactory(string sql, string connString, int firstColumn, int countColumns, IDataReader r)
            {
                ...
                return PocoFactories.Get(key, () =>
                                              {
                                                  // Create the method
                                                  var m = new DynamicMethod("petapoco_factory_" + PocoFactories.Count.ToString(), type, new Type[]
                                                                                                                                        {
                                                                                                                                            typeof (IDataReader)
                                                                                                                                        }, true);
                                                  var il = m.GetILGenerator();
                            ...
                            */
                                                      ...
                                                      else
                                                      {
                                                          ...
                                                          for (int i = firstColumn; i < firstColumn + countColumns; i++)
                                                          {
                                                              ...
                                                              if (converter == null)
                                                              {
                                                                  var valuegetter = typeof (IDataRecord).GetMethod("Get" + srcType.Name, new Type[]
                                                                                                                                         {
                                                                                                                                             typeof (int)
                                                                                                                                         });
                                                                  if (valuegetter != null
                                                                       ...
                                                                       valuegetter.ReturnType == Nullable.GetUnderlyingType(dstType)))
                                                                  {
                                                                      ...
                                                                      {
                                                                          il.Emit(OpCodes.Newobj, dstType.GetConstructor(new Type[]
                                                                                                                         {
                                                          ...
                                                          var fnOnLoaded = RecurseInheritedTypes<MethodInfo>(type,
                                                              (x) =>
                                                              x.GetMethod("OnLoaded", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null,
                                                                  new Type[0], null));
                                                          if (fnOnLoaded != null)
                                                          {
                                                              il.Emit(OpCodes.Dup);
            ...
            private static MethodInfo fnGetValue = typeof (IDataRecord).GetMethod("GetValue", new Type[]
                                                                                              {
                                                                                                  typeof (int)
                                                                                              });
            private static MethodInfo fnIsDBNull = typeof (IDataRecord).GetMethod("IsDBNull");
            private static FieldInfo fldConverters = typeof (PocoData).GetField("_converters",
                BindingFlags.Static | BindingFlags.GetField | BindingFlags.NonPublic);
            private static MethodInfo fnListGetItem = typeof (List<Func<object, object>>).GetProperty("Item")
                                                                                         .GetGetMethod();
                ...
                if (!rxSelect.IsMatch(sql))
                {
                    ...
                    string cols = pd.Columns.Count != 0
                                      ? string.Join(", ", (from c in pd.QueryColumns
                                                           select tableName + "." + DatabaseType.EscapeSqlIdentifier(c)).ToArray())
                                      : "NULL";
                ...
                Dictionary<string, object> map = _types.Get(enumType, () =>
                                                                      {
                                                                          ...
                                                                          var newmap = new Dictionary<string, object>(values.Length,
        ...
        internal static class PagingHelper
        {
            ...
            public static bool SplitSQL(string sql, out SQLParts parts)
            {
                ...
                if (rxDistinct.IsMatch(parts.sqlSelectRemoved))
                    parts.sqlCount = sql.Substring(0, g.Index) + "COUNT(" + m.Groups[1].ToString()
                                                                                       .Trim() + ") " + sql.Substring(g.Index + g.Length);
                else
            ...
            public override string BuildPageQuery(long skip, long take, PagingHelper.SQLParts parts, ref object[] args)
            {
                ...
                var sqlPage = string.Format("SELECT * FROM (SELECT ROW_NUMBER() OVER ({0}) peta_rn, {1}) peta_paged WHERE peta_rn>@{2} AND peta_rn<=@{3}",
                    parts.sqlOrderBy == null
                        ...
                        : parts.sqlOrderBy, parts.sqlSelectRemoved, args.Length, args.Length + 1);
                args = args.Concat(new object[]
                                   {
                                       skip, skip + take
                                   })
