CREATE TABLE [dbo].[ScheduleMasters] (
    ...
    [OnHold]                              BIT            CONSTRAINT [DF__ScheduleM__OnHol__55209ACA] DEFAULT ((0)) NULL,
...
GO
CREATE NONCLUSTERED INDEX [ScheduleMasters_RTSDATEID]
    ON [dbo].[ScheduleMasters]([ReferralTSDateID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ScheduleMasters_ReferralAuthorizationID]
    ON [dbo].[ScheduleMasters]([ReferralBillingAuthorizationID] ASC);
...
GO
CREATE NONCLUSTERED INDEX [IX_scheduleMaster003]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC, [EmployeeID] ASC)
    INCLUDE([ReferralID], [StartDate], [EndDate], [OnHold]);


GO
CREATE NONCLUSTERED INDEX [IX_scheduleMaster002]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC, [IsPatientAttendedSchedule] ASC)
    INCLUDE([ReferralID], [StartDate], [EndDate], [OnHold]);


GO
CREATE NONCLUSTERED INDEX [missing_index_211152_211151_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC)
    INCLUDE([ReferralID], [StartDate], [ReferralBillingAuthorizationID]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210983_210982_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC, [StartDate] ASC, [EndDate] ASC)
    INCLUDE([ReferralID], [EmployeeID], [CareTypeId], [OnHold]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210699_210698_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([PayorID] ASC, [StartDate] ASC, [EndDate] ASC)
    INCLUDE([ReferralID]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210289_210288_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC)
    INCLUDE([ReferralID], [StartDate], [EndDate], [EmployeeID], [ReferralTSDateID], [OnHold]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210287_210286_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC, [EmployeeID] ASC)
    INCLUDE([ReferralID], [StartDate], [EndDate], [ReferralTSDateID], [OnHold]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210283_210282_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([IsDeleted] ASC, [FacilityID] ASC)
    INCLUDE([ReferralID], [StartDate], [EndDate], [OnHold]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210281_210280_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([StartDate] ASC)
    INCLUDE([EndDate], [EmployeeID]);


GO
CREATE NONCLUSTERED INDEX [missing_index_210277_210276_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([ReferralID] ASC, [IsDeleted] ASC)
    INCLUDE([OnHold]);


GO
CREATE NONCLUSTERED INDEX [missing_index_209431_209430_ScheduleMasters]
    ON [dbo].[ScheduleMasters]([IsVirtualVisit] ASC)
    INCLUDE([ReferralID], [StartDate], [EmployeeID]);
