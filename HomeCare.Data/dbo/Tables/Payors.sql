CREATE TABLE [dbo].[Payors] (
    ...
    [ClaimProcessor]            NVARCHAR (MAX) NULL,
    [VisitBilledBy]             NVARCHAR (MAX) NULL,
    [EraPayorID]                NVARCHAR (MAX) NULL,
    [ERAEnroll_Status] NVARCHAR (10) NULL,
	[ERAEnroll_Log] NVARCHAR(max) NULL,
	[CMS1500Enroll_Status] NVARCHAR(10) NULL,
	[CMS1500Enroll_Log] NVARCHAR (max) NULL,
