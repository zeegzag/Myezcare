...
GO
CREATE NONCLUSTERED INDEX [missing_index_220552_220551_ReferralDocuments]
    ON [dbo].[ReferralDocuments]([FileName] ASC, [UserID] ASC, [ComplianceID] ASC)
    INCLUDE([GoogleFileId]);


GO
CREATE NONCLUSTERED INDEX [missing_index_209413_209412_ReferralDocuments]
    ON [dbo].[ReferralDocuments]([ExpirationDate] ASC)
    INCLUDE([FileName], [UserID], [UserType]);
