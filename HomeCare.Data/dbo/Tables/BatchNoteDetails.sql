CREATE TABLE [dbo].[BatchNoteDetails] (
    [BatchNoteDetailID]          BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    [MarkAsComplete]             BIT           CONSTRAINT [DF_BatchNoteDetail_MarkAsComplete] DEFAULT ((0)) NOT NULL,
    ...
    [IsBillable]                 BIT           CONSTRAINT [DF_BatchNoteDetail_IsBillable] DEFAULT ((0)) NOT NULL,
    [HasGroupOption]             BIT           CONSTRAINT [DF_BatchNoteDetail_HasGroupOption] DEFAULT ((0)) NOT NULL,
    [PayorServiceCodeMappingID]  BIGINT        NULL,
    [PayorID]                    BIGINT        NULL,
    [IsDeleted]                  BIT           CONSTRAINT [DF_BatchNoteDetail_IsDeleted] DEFAULT ((0)) NOT NULL,
    [NoOfStops]                  INT           NULL,
...
EmployeeVisitNoteIDs nvarchar(max),
ScheduleID bigint,
...
SupervisingProvidername2420DLoop_REF02_ReferenceId  VARCHAR(100),
    CONSTRAINT [PK_BatchNoteDetails] PRIMARY KEY CLUSTERED ([BatchNoteDetailID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [Nonclustered_BatchNoteDetails_NoteID]
    ON [dbo].[BatchNoteDetails]([NoteID] ASC);


GO
CREATE NONCLUSTERED INDEX [Nonclustered_BatchNoteDetails_BatchNoteID]
    ON [dbo].[BatchNoteDetails]([BatchNoteID] ASC);


GO
CREATE NONCLUSTERED INDEX [Nonclustered_BatchNoteDetails_BatchID]
    ON [dbo].[BatchNoteDetails]([BatchID] ASC);
