...
SELECT ReferralDocumentID,ComplianceID,Name=FileName,FilePath,KindOfDocument,AddedBy=dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat),ReceivedDate=RD.CreatedDate,            
ExpirationDate                
...
--          FOR XML PATH('')), 1, 2, ''),                
AddedBy=dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat),ReceivedDate=EBFM.CreatedDate                
