...
END        
  --UpdatedBy:Akhilesh kamal
   ...
   --Description:delete visittask for permanent
IF(LEN(@ListOfIdsInCsv)>0 )                      
BEGIN         
DELETE FROM EmployeeVisitNotes WHERE EmployeeVisitNoteID in (SELECT CAST(Val AS VARCHAR(100)) FROM GetCSVTable(@ListOfIdsInCsv))               
