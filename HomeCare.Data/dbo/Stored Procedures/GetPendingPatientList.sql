--  EXEC GetPendingPatientList @StartDate = '2021-05-25', @EndDate = '2021-05-25', @SortExpression = 'Patient', @SortType = 'ASC', @FromIndex = '1', @PageSize = '10'                
CREATE PROCEDURE [dbo].[GetPendingPatientList]                    
@StartDate DATE =NULL,                                        
@EndDate  DATE=NULL,                     
...
;WITH CTEGetPendingPatientList AS                                      
 (                                       
...
WHERE R.IsDeleted=0 AND R.ReferralStatusID=16 AND                 
...
SELECT * FROM CTEGetPendingPatientList WHERE ROW BETWEEN ((@PageSize*(@FromIndex-1))+1) AND (@PageSize*@FromIndex)                                       
END  