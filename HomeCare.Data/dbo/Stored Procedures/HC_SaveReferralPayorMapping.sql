...
@BeneficiaryTypeID bigint,  
@BeneficiaryNumber varchar(100),
...
BEGIN     
 ...
 SELECT @MasterJurisdictionID = NULLIF(@MasterJurisdictionID, 0), @MasterTimezoneID = NULLIF(@MasterTimezoneID, 0)
 IF EXISTS (      
 ...
 BEGIN      
  INSERT INTO ReferralPayorMappings (ReferralID,PayorID,PayorEffectiveDate,PayorEffectiveEndDate,IsActive,IsDeleted,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy,SystemID,  
         ...
         InsuredPolicyGroupOrFecaNumber,InsuredDateOfBirth,InsuredGender,InsuredEmployersNameOrSchoolName,BeneficiaryTypeID,BeneficiaryNumber,MemberID,MasterJurisdictionID,MasterTimezoneID)      
  VALUES (@ReferralID,@PayorID,@StartDate,@EndDate,1,0,@CurrentDate,@loggedInUserId,@CurrentDate,@loggedInUserId,@SystemID,@Precedence,@IsPayorNotPrimaryInsured,@InsuredId,  
   ...
   @InsuredDateOfBirth,@InsuredGender,@InsuredEmployersNameOrSchoolName,@BeneficiaryTypeID,@BeneficiaryNumber,@MemberID,@MasterJurisdictionID,@MasterTimezoneID)  
 END      
 ELSE      
 BEGIN       
 ...
 MemberID=@MemberID,
 MasterJurisdictionID=@MasterJurisdictionID,
