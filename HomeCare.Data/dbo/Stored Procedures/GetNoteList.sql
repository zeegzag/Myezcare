...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat() 
  ...
  * FROM (  
  SELECT DISTINCT n.NoteID,--BN.BatchID,case when B.IsSent=1 then 1 else 0 end as IsSent,  
   ...
   n.PerUnitQuantity,n.POSDetail,n.POSEndDate,n.PosID,n.POSStartDate,n.Rate,n.ReferralID,n.Relation,n.ServiceCode,n.ServiceCodeEndDate,n.Source,e.UserName as CreatedByUserName,  
   ...
   es.UserName as SignatureBy,dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat) as ReferralName,  
   n.SystemID,n.ZarephathService,n.PayorShortName,n.UnitType,n.UpdatedBy,n.UpdatedDate,pos.PosName,m.ModifierName,n.IsDeleted,CASE when n.CreatedBy > 0 then dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat) else n.Source END as Name,  
   sct.ServiceCodeTypeName,AllowEdit=1,--CASE WHEN (select count(*) from BatchNotes where NoteID=n.NoteID AND BatchNoteStatusID not in(SELECT CAST(VAL AS BIGINT) FROM GETCSVTABLE(@AllowEditStatuses))) >0 then 0 else 1 end As AllowEdit,  
   N.AttachmentURL,N.NoteComments  
   --,  
