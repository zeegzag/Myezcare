...
E.FirstName, LastName, Patient = dbo.GetGenericNameFormat(E.FirstName,E.MiddleName, E.LastName,@NameFormat),          
...
LEFT JOIN ScheduleMasters SM ON SM.ReferralTSDateID= ETD.ReferralTSDateID AND ISNULL(SM.OnHold, 0) = 0 AND SM.IsDeleted=0        
