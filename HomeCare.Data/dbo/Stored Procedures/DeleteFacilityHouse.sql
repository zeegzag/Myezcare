CREATE PROCEDURE [dbo].[DeleteFacilityHouse]
...
BEGIN    
	...
	IF(@IsShowList=1)
	BEGIN
		EXEC GetFacilityHouseList @FacilityName,@County,@RegionID,@Phone,@NPI,@AHCCCSID,@EIN,@PayorApproved,@IsDeleted,@SortExpression, @SortType, @FromIndex, @PageSize
	END
END