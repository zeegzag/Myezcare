...
SELECT DISTINCT   
EmployeeID,FirstName,LastName,  dbo.GetGenericNameFormat(FirstName,MiddleName, LastName,@NameFormat) AS Employee,
...
SELECT --SM.*,  
E.EmployeeID, E.FirstName, E.LastName, E.MiddleName,
