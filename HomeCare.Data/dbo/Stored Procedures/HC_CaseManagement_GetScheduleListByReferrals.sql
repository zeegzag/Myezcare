...
BEGIN                           
 ...
 SELECT R.ReferralID, R.FirstName,R.LastName,dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat) AS ReferralName,
 C.Phone1,C.Phone2, C.Email,RTD.ReferralTSDateID,                  
 RTD.UsedInScheduling,RTD.OnHold,ScheduleComment=RTD.Notes, V.[ClockInTime],V.[IsPCACompleted],  
 ...
 LEFT JOIN EmployeeVisits V on SM.ScheduleID = V.ScheduleID           
