 ...
 (   
  ...
  (  
   SELECT ROW_NUMBER() OVER (ORDER BY   
    ...
    CASE WHEN @SortType = 'ASC' THEN CASE WHEN @SortExpression = 'NPI' THEN fac.NPI END END ASC,  
    CASE WHEN @SortType = 'DESC' THEN CASE WHEN @SortExpression = 'NPI' THEN fac.NPI END END DESC,  
