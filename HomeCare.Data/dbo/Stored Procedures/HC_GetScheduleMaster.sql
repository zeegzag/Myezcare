...
CREATE PROCEDURE [dbo].[HC_GetScheduleMaster]      
 @ScheduleID bigint=0,                    
 @StartDate date=null,                    
 @EndDate date=null,                    
...
select @Item9=splitdata  from dbo.fnSplitString(@SortIndexArray,',')  WHERE ROWID=9        
 ...
 CASE WHEN  'EmployeeName ASC'= @Item1 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item1  THEN  E.FirstName   END DESC,        
 ...
 CASE WHEN 'EndDate DESC'=@Item2  THEN CONVERT(datetime, sm.StartDate, 103) END DESC,    
  ...
  CASE WHEN  'Age ASC'= @Item2 THEN  R.Dob END  ASC, CASE WHEN 'Age DESC'= @Item2  THEN   R.Dob   END DESC,        
    CASE WHEN  'EmployeeName ASC'= @Item2 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item2  THEN  E.FirstName   END DESC,        
 ...
 CASE WHEN  'Age ASC'= @Item3 THEN   R.Dob END  ASC, CASE WHEN 'Age DESC'= @Item3  THEN   R.Dob   END DESC,        
    CASE WHEN  'EmployeeName ASC'= @Item3 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item3  THEN  E.FirstName   END DESC,        
 ...
 CASE WHEN  'Age ASC'= @Item4 THEN   R.Dob END  ASC, CASE WHEN 'Age DESC'= @Item4  THEN   R.Dob   END DESC,        
    CASE WHEN  'EmployeeName ASC'= @Item4 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item4  THEN  E.FirstName   END DESC,      
 ...
 CASE WHEN  'Age ASC'= @Item5 THEN  R.Dob END  ASC, CASE WHEN 'Age DESC'= @Item5  THEN   R.Dob  END DESC,        
    CASE WHEN  'EmployeeName ASC'= @Item5 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item5  THEN  E.FirstName   END DESC,        
    ...
    CASE WHEN  'StartDate ASC'=@Item6 THEN CONVERT(datetime, sm.StartDate, 103) END  ASC,CASE WHEN 'StartDate DESC'=@Item6  THEN CONVERT(datetime, sm.StartDate, 103) END DESC,        CASE WHEN  'EndDate ASC'=@Item6 THEN CONVERT(datetime, sm.StartDate, 103
) END  ASC,    
 ...
 CASE WHEN  'EmployeeName ASC'= @Item6 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item6  THEN  E.FirstName   END DESC,        
 ...
 CASE WHEN  'EmployeeName ASC'= @Item7 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item7  THEN  E.FirstName   END DESC,        
 ...
 CASE WHEN  'Age ASC'= @Item8 THEN   R.Dob END  ASC, CASE WHEN 'Age DESC'= @Item8  THEN  R.Dob  END DESC,        
    CASE WHEN  'EmployeeName ASC'= @Item8 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item8  THEN  E.FirstName   END DESC,        
 ...
 CASE WHEN  'Age ASC'= @Item9 THEN   R.Dob END  ASC, CASE WHEN 'Age DESC'= @Item9  THEN  R.Dob  END DESC,        
    CASE WHEN  'EmployeeName ASC'= @Item9 THEN  E.LastName END  ASC, CASE WHEN 'Facility DESC'= @Item9  THEN  E.FirstName   END DESC,       
  ...
  CASE WHEN @SortType = 'ASC' THEN CASE WHEN @SortExpression = 'EmployeeName' THEN E.LastName END END ASC,                    
     CASE WHEN @SortType = 'DESC' THEN CASE WHEN @SortExpression = 'EmployeeName' THEN E.LastName END END DESC,                   
  ...
  CASE WHEN @SortType = 'DESC' THEN CASE WHEN @SortExpression = 'Address' THEN c.Address END END DESC                 
    ...
    sm.ScheduleID,sm.ReferralID,sm.FacilityID,f.FacilityName,sm.EmployeeID,    
 EmployeeName=dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat) ,EmpEmail=E.Email,EmpMobile=E.MobileNumber,      
...
dbo.GetGenericNameFormat(c.FirstName,'', c.LastName,@NameFormat) as ParentName,c.Phone1,c.Phone2,                    
 ...
 r.RegionID,                    
    ...
    SM.EmailSent,SM.SMSSent,SM.NoticeSent,r.PCMVoiceMail,r.PCMMail,R.PCMSMS,r.PCMEmail,sm.CareTypeId ,DM.Title as CareType,  
    EV.EmployeeVisitID, sm.ReferralTSDateID  
   ...
   AND ((@StartDate is null OR (CONVERT(DATE,SM.StartDate) >= @StartDate)) and (@EndDate is null OR (CONVERT(DATE,SM.EndDate) <= @EndDate)))                    
   AND (      
     ((CAST(@PreferredCommunicationMethodID AS bigint)=0)   )      
       OR  (CAST(@PreferredCommunicationMethodID AS bigint) = 5 and       
       ( (r.PCMVoiceMail IS NULL OR r.PCMVoiceMail = 0)  AND  (r.PCMEmail IS NULL OR r.PCMEmail = 0) AND (r.PCMSMS IS NULL OR r.PCMSMS = 0) AND    
    (r.PCMMail IS NULL OR r.PCMMail = 0)  )  )                                
