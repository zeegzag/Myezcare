...
SELECT            
 r.BMI,R.*,            
    ...
    AgencyName = NULL,                  
    P.PayorName,                  
    CaseManager = dbo.GetGeneralNameFormat(CM.FirstName, CM.LastName),                  
...
where lu.Name='Location of Service' AND DM.IsDeleted=0
  ...
  SELECT                  
    ...
    RPM.IsActive,                  
    P.PayorName,                  
    dbo.GetGeneralNameFormat(E.FirstName, E.LastName) AS AddedByName,                  
    dbo.GetGeneralNameFormat(E1.FirstName, E1.LastName) AS UpdatedByName,                  
    RPM.CreatedDate,                  
    RPM.UpdatedDate                  
  FROM ReferralPayorMappings RPM                  
  INNER JOIN Payors P                  
