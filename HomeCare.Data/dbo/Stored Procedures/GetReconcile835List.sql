...
CREATE PROCEDURE [dbo].[GetReconcile835List]              
@PayorID bigint =0,          
...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat() 
 ...
 ClaimNumber=BN.CLP01_ClaimSubmitterIdentifier,PayorClaimNumber=BN.CLP07_PayerClaimControlNumber,    
    BillingProvider=N.BillingProviderName,N.BillingProviderNPI, ClientName= dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat),ClientDob= R.Dob, R.AHCCCSID, R.CISNumber, R.Population,             
