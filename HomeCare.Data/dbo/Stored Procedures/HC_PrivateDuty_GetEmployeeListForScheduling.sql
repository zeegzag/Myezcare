...
SET @StrPreferenceList=NULL;          
 ...
 ;WITH CTE01TempEmployeeList AS                                
    (              
  SELECT DISTINCT E.EmployeeID, E.FirstName,E.LastName ,dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat) AS EmployeeName        
  FROM Employees E          
 ...
 SELECT DISTINCT E.EmployeeID, E.FirstName,E.LastName, E.EmployeeName,        
