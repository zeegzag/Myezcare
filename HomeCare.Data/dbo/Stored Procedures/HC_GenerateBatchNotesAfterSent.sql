...
BEGIN                
 ...
 EmployeeVisitID,EmployeeVisitNoteIDs ,ScheduleID ,ReferralTSDateID ,ReferralBillingAuthorizationID ,RenderingProvider_TaxonomyCode,  
 ...
 NT.EmployeeVisitID,NT.EmployeeVisitNoteIDs ,NT.ScheduleID ,NT.ReferralTSDateID ,NT.ReferralBillingAuthorizationID ,NT.RenderingProvider_TaxonomyCode,  
 NT.SupervisingProvidername2420DLoop_NM103_NameLastOrOrganizationName,NT.SupervisingProvidername2420DLoop_NM104_NameFirst,NT.SupervisingProvidername2420DLoop_REF02_ReferenceId  
 FROM Notes NT                
    INNER JOIN (                
  ...
  INNER JOIN ReferralPayorMappings AS RPM  ON N.ReferralID = RPM.ReferralID        
  INNER JOIN ReferralBillingAuthorizations AS PSM  ON PSM.ReferralID = RPM.ReferralID   AND PSM.ReferralBillingAuthorizationID = N.ReferralBillingAuthorizationID            
