...
BEGIN              
 ...
 WHERE sm.EmployeeID=@EmployeeID AND CONVERT(DATE,sm.StartDate)=@Today AND sm.ReferralID IN (SELECT * FROM @tmpTable tt) AND ISNULL(SM.OnHold, 0) = 0 AND sm.IsDeleted=0    
