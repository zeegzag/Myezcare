...
CREATE PROCEDURE [dbo].[HC_GetPriorAuthorizationList]
...
AS                                                            
BEGIN                                                              
;WITH CTEGetPriorAuthorizationList AS                                                        
 (                                                             
 ...
 SELECT * FROM CTEGetPriorAuthorizationList WHERE ROW BETWEEN ((@PAGESIZE*(@FROMINDEX-1))+1) AND (@PAGESIZE*@FROMINDEX)                                          
END