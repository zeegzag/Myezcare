...
BEGIN      
 ...
 e.CanUpdateCoordinate  
  ...
  SELECT      
    ...
    C.FirstName,      
    C.LastName,   
	FullName=dbo.GetGenericNameFormat(C.FirstName,'', C.LastName,@NameFormat),
    C.[Address],      
    C.LanguageID,      
    C.Email,      
    C.ApartmentNo,      
	...
	EmpFullName=dbo.GetGenericNameFormat(E.FirstName,E.MiddleName, E.LastName,@NameFormat),
    C.Latitude,      
    C.Longitude      
