...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat()
 SELECT CM.ContactMappingID, CT.ContactTypeID ,CT.ContactTypeName,CM.ROIType,CM.ROIExpireDate,C.FirstName, C.LastName,FullName=dbo.GetGenericNameFormat(C.FirstName,'', C.LastName,@NameFormat),
 C.[Address], C.LanguageID,    
 ...
 C.ContactID,CM.EmployeeID,CM.ClientID, E.FirstName AS EmpFirstName, E.LastName AS EmpLastName ,EmpFullName = dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat)   
 FROM Contacts C    
