...
--Description: For Save physicianType in Physician table
...
BEGIN                              
 ...
 BEGIN                              
   ...
   (FirstName,MiddleName,LastName,Address,City,StateCode,ZipCode,Email,Phone,Mobile,NPINumber,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,SystemID,PhysicianTypeID)            
   VALUES                              
   (@FirstName,@MiddleName,@LastName,@Address,@City,@StateCode,@ZipCode,@Email,@Phone,@Mobile,@NPINumber,            
   @loggedInUserId,GETUTCDATE(),@loggedInUserId,GETUTCDATE(),@SystemID,@PhysicianTypeID);            
 ...
 SystemID=@SystemID,  
 PhysicianTypeID=@PhysicianTypeID            
