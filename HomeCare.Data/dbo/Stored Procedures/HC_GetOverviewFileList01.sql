-- EXEC HC_GetOverviewFileList @BatchID = '134'      
CREATE PROCEDURE [dbo].[HC_GetOverviewFileList01]                 
...
BEGIN                 
 ...
 BEGIN      
  ...
  Select  R.ReferralID,BN.NoteID,BN.BatchID,ClientName=dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat),R.FirstName,R.LastName,C.Address,C.City,C.State,C.ZipCode, R.Gender, ClientDob=CONVERT(VARCHAR(10), R.Dob, 101),R.AHCCCSID,R.CISNumber,                  
