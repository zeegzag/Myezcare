...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat() 
 ...
 WHERE RCM.ReferralID=@ReferralID AND RCM.Value=1 AND RCM.ExpirationDate<@OrganizationDate    
  ...
  SELECT dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat) AS ClientName, E.Email AS ToEmail,C.Email,E.FirstName as CaseManagerFirstName,E.LastName  as CaseManagerLastName,R.ClientNickName  
