...
SELECT ReferralID,RefPreferenceID,EmpPreferenceID,EmployeeID,FirstName,LastName,EmployeeName, IsDeleted,OrderRank,PreferencesMatchCount,SkillsMatchCount,EmpLatLong,KeyType FROM (  
  
SELECT R.ReferralID,PE.KeyType,  
RefPreferenceID=RP.PreferenceID,EmpPreferenceID=EP.PreferenceID,E.EmployeeID,E.FirstName,E.LastName,dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat) AS EmployeeName, E.IsDeleted, EmpLatLong=[dbo].GetGeoFromLatLng(E.Latitude,E.Longitude),  
