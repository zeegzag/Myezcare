...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat()
 ...
 C.FirstName, C.LastName,FullName=dbo.GetGenericNameFormat(C.FirstName,'', C.LastName,@NameFormat), C.[Address], C.LanguageID,  
 C.PHONE1,  
 C.Phone2,   
 C.City,  
 C.State,  
 ...
 IsNull(E.LastName, R.LastName) AS EmpLastName  ,EmpFullName = dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat)
 FROM Contacts C  
