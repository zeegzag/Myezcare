...
BEGIN          
  DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat()
         ...
         SELECT  R. ReferralID,dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat) as ReferralName, n.NoteID,n.CalculatedUnit,StartTime,EndTime,  
