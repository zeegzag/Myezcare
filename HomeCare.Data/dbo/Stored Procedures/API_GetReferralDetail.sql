...
BEGIN                      
 ...
 sm.StartDate as ServiceDate,sm.EndDate as EndDate ,ImageUrl=r.ProfileImagePath,c.ContactID,Account=r.AHCCCSID,r.Gender,Language=l.Title,c.Email,    
 Phone=c.Phone1,EmergencyPhone=ec.Phone1, sm.IsVirtualVisit ,dm.Title as CareType    
