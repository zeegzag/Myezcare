...
BEGIN                         
 ...
 SELECT R.ReferralID, R.FirstName,R.LastName,dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat) AS ReferralName, C.Phone1,C.Phone2, 
 C.Email,SM.ScheduleID,SS.ScheduleStatusName,RTD.ReferralTSDateID,                
 ...
 EmpFirstName = E.FirstName, EmpLastName= E.LastName,dbo.GetGenericNameFormat(e.FirstName,e.MiddleName, e.LastName,@NameFormat) AS EmployeeName,
 EmpEmail=E.Email, EmpMobile=E.MobileNumber, E.EmployeeUniqueID  ,E.EmployeeID,  
