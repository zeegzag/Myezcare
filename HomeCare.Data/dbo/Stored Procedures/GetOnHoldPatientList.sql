--  EXEC GetOnHoldPatientList @StartDate = '2021/05/26', @EndDate = '2021/05/26', @SortExpression = 'Patient', @SortType = 'ASC', @FromIndex = '1', @PageSize = '10'                
CREATE PROCEDURE [dbo].[GetOnHoldPatientList]                    
@StartDate DATE =NULL,                                        
@EndDate  DATE=NULL,                     
...
;WITH CTEGetOnHoldPatientList AS                                      
 (                                       
...
WHERE R.IsDeleted=0 AND R.ReferralStatusID=12 AND    
...
SELECT * FROM CTEGetOnHoldPatientList WHERE ROW BETWEEN ((@PageSize*(@FromIndex-1))+1) AND (@PageSize*@FromIndex)                                       
END  