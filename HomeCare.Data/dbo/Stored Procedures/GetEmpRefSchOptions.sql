...
SET @TotalSkillCount = 1;            
 ...
 --       --,ETSD.StartTime             
 --       --,ETSD.EndTime   
 -- ORDER BY ETSD.EmployeeTimeSlotDetailID              
 --       ),               
...
--      ((@SkillId!=0 AND @PreferenceId=0) AND (EP.PreferenceID = @SkillId)) OR                                          
  ...
  -- 08 Apr 2021, issue found for client Pathmedic, employee [CAMPOS, MAYRA] is not available to assign for patient [CRUZ, JUAN]    -- START  
