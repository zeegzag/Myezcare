...
BEGIN        
 ...
 SELECT EmployeeID Value,dbo.GetGenericNameFormat(FirstName,MiddleName, LastName,@NameFormat) AS Name FROM Employees where IsActive=1 and IsDeleted=0 Order By LastName ASC       
