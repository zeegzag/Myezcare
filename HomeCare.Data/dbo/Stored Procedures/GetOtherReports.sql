CREATE PROCEDURE [dbo].[GetOtherReports]             
...
--SELECT * from ReportMaster RM where RM.IsDeleted=0 AND RM.Category='Other' AND RM.IsDisplay=1           
...
where rpm.IsDeleted=0 and rm.IsDeleted=0 and rm.IsActive=1 and IsDisplay=1 AND RM.Category='Other' and e.EmployeeID=@loggedInUser
