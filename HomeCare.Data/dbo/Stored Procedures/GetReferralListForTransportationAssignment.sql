...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat() 
 ...
 SELECT ROW_NUMBER() OVER (ORDER BY       
  ...
  R.ReferralID, dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat) as Name,    
  R.Gender,dbo.GetAge(R.Dob) Age ,    
  dbo.GetGenericNameFormat(C.FirstName,'', C.LastName,@NameFormat) as ParentName,C.Phone1 Phone ,C.Phone2,    
