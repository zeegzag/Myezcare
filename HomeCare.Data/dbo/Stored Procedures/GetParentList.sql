...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat() 
 ...
 (     
   ...
   * FROM (  
   ...
   SELECT C.ContactID,  dbo.GetGenericNameFormat(C.FirstName,'', C.LastName,@NameFormat) AS Name, C.Email,C.Address, C.City, C.State, C.ZipCode, C.Phone1, C.Phone2,CT.ContactTypeName,C.IsDeleted,  
