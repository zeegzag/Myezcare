...
DECLARE @NameFormat VARCHAR(500) = dbo.GetOrgNameFormat()
 ...
 CASE WHEN @SortType = 'ASC' THEN CASE WHEN @SortExpression = 'Count' THEN TBL1.NumOfTime END END ASC,          
   ...
   SELECT DISTINCT CareTypeTimeSlotID,SM.ReferralID,SM.CareTypeID,CareTypeName=DD.Title,Name=dbo.GetGenericNameFormat(r.FirstName,r.MiddleName, r.LastName,@NameFormat),NumOfTime=SM.[Count],SM.Frequency,          
   SM.StartDate,SM.EndDate, CaseManagerName=dbo.GetGenericNameFormat(CM.FirstName,'', CM.LastName,@NameFormat)        
