CREATE TABLE [dbo].[JO_ReferralCheckLists] (
    [JO_ReferralCheckListID]                    BIGINT        IDENTITY (1, 1) NOT NULL,
    [ReferralCheckListID]                       BIGINT        NOT NULL,
    ...
    [AHCCCSVerificationText]                    VARCHAR (100) NULL,
    ...
    [SPExpireAndGuardianBHPSignedText]          VARCHAR (100) NULL,
    [CoreAssessmentORAnnualUpdateCompleted]     BIT           NOT NULL,
    [CoreAssessmentORAnnualUpdateCompletedText] VARCHAR (100) NULL,
    ...
    [SNCDText]                                  VARCHAR (100) NULL,
    [Demographics]                              VARCHAR (100) NULL,
    [DemographicsText]                          VARCHAR (100) NULL,
    ...
    [SPSignedByBHP]                             BIT           NULL,
    [SPSignedByBHPText]                         VARCHAR (100) NULL,
    [SPSignedByGuardian]                        BIT           NULL,
    [SPSignedByGuardianText]                    VARCHAR (100) NULL,
    [IsCheckListOffline]                        BIT           NULL,
    CONSTRAINT [PK_JO_ReferralCheckLists] PRIMARY KEY CLUSTERED ([JO_ReferralCheckListID] ASC)
);
