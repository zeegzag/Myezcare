...
GO
CREATE TRIGGER [dbo].[tr_RolePermissionMapping_Deleted] ON [dbo].[RolePermissionMapping]
FOR DELETE AS 
...
GO
DISABLE TRIGGER [dbo].[tr_RolePermissionMapping_Deleted]
    ON [dbo].[RolePermissionMapping];
...
GO
DISABLE TRIGGER [dbo].[tr_RolePermissionMapping_Updated]
    ON [dbo].[RolePermissionMapping];
