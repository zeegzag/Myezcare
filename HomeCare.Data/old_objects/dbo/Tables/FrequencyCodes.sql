...
GO
CREATE TRIGGER [dbo].[tr_FrequencyCodes_Deleted] ON [dbo].[FrequencyCodes]
FOR DELETE AS 
...
GO
DISABLE TRIGGER [dbo].[tr_FrequencyCodes_Deleted]
    ON [dbo].[FrequencyCodes];
...
GO
DISABLE TRIGGER [dbo].[tr_FrequencyCodes_Updated]
    ON [dbo].[FrequencyCodes];
