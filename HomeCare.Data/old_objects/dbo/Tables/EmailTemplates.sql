...
GO
CREATE TRIGGER [dbo].[tr_EmailTemplates_Deleted] ON [dbo].[EmailTemplates]
FOR DELETE AS 
...
GO
DISABLE TRIGGER [dbo].[tr_EmailTemplates_Deleted]
...
GO
DISABLE TRIGGER [dbo].[tr_EmailTemplates_Updated]
    ON [dbo].[EmailTemplates];
