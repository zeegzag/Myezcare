...
BEGIN    
        ...
        SELECT ReferralID,FirstName,LastName,AHCCCSID,Dob, RecordRequestEmail, CaseManager,
		...
		FROM
    (
	        select  R.ReferralID, R.FirstName,R.LastName,R.AHCCCSID,R.CISNumber,
			ISNULL(R.MonthlySummaryEmail,CM.Email)as RecordRequestEmail,R.Dob,CM.FirstName + ' ' + CM.LastName as CaseManager, 
