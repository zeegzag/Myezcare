...
END                    
  ...
  -- Added  ReferralTSEndTime2 new column to fix the issue of plus one day.          
  --Create Slots                
  ...
  SELECT T.ReferralID,T.ReferralTimeSlotMasterID, T.ReferralTSDate,T.ReferralTSStartTime,T.ReferralTSEndTime,                
   ...
   ReferralTSEndTime2 = CONVERT(DATETIME, CONVERT(CHAR(8), T1.IndividualDate, 112) + ' ' + CONVERT(CHAR(8), EndTime, 108)),          
