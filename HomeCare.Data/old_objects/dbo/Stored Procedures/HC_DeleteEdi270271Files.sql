CREATE PROCEDURE [dbo].[HC_DeleteEdi270271Files]
...
BEGIN              
 ...
 IF(@IsShowList=1)          
 BEGIN          
  EXEC HC_GetEdi270271FileList  @FileType ,@FileName ,@Comment,@PayorID,@ServiceID,@ClientName,@EligibilityCheckDate,@Upload271FileProcessStatus,@IsDeleted,@AllServiceText,@SortExpression,@SortType ,@FromIndex,@PageSize        
 END          
END
