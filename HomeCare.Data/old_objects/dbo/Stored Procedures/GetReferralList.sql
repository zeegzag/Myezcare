    ...
    (
      ...
      (
        SELECT DISTINCT
          ...
          RS.Status,
          r.Assignee,
          e.LastName + ', ' + e.FirstName AS AssigneeName,--rp.PayorID,p.ShortName as ContractName,            
          r.PlacementRequirement,
          r.CaseManagerID,
          cm.LastName + ', ' + cm.FirstName AS FaciliatorName,
          r.ZSPLifeSkills,
          r.ZSPRespite,
          r.ZSPCounselling,
          r.CreatedDate,
          r.CreatedBy,
          eself.LastName + ', ' + eself.FirstName AS CreatedName,
          a.NickName AS CompanyName,
          al.LocationName,
          rc.IsCheckListCompleted,
          rc.ChecklistCompletedBy,
          er.LastName + ' ' + er.FirstName AS CheckListName,
          rc.ChecklistCompletedDate,
          rsf.IsSparFormCompleted,
          rsf.SparFormCompletedBy,
          es.LastName + ', ' + es.FirstName AS ClinicalReviewName,
          rsf.SparFormCompletedDate,
          r.NotifyCaseManager,
          r.AgencyID,
          r.AgencyLocationID,
          r.UpdatedDate,
          eselfUP.LastName + ', ' + eselfUP.FirstName AS UpdatedName,
          r.IsDeleted,
          r.CounselingService,
          r.LifeSkillsService,
          r.RespiteService,
