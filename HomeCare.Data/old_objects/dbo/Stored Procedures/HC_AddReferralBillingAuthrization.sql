...
BEGIN TRANSACTION trans                                        
 ...
 BEGIN                      
  INSERT INTO ReferralBillingAuthorizations (ReferralID,Type,AuthorizationCode,PayorID,AllowedTime,StartDate,EndDate,PriorAuthorizationFrequencyType,ServiceCodeID,Rate,RevenueCode,UnitType,PerUnitQuantity,RoundUpUnit,MaxUnit,DailyUnitLimit,CareType,ModifierID,TaxonomyID,AllowedTimeType,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy,SystemID, AttachmentFileName, AttachmentFilePath)              
    
  VALUES(@ReferralID,@Type,@AuthorizationCode,@PayorID,@AllowedTime,@StartDate,@EndDate,@PriorAuthorizationFrequencyType,  
  @ServiceCodeID,@Rate,@RevenueCode,@UnitType,@PerUnitQuantity,@RoundUpUnit,@MaxUnit,@DailyUnitLimit,@CareType,@ModifierID,@TaxonomyID,@AllowedTimeType,GETUTCDATE(),@loggedInID,GETUTCDATE(),@loggedInID,@SystemID, @AttachmentFileName, @AttachmentFilePath) 
