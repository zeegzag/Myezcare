CREATE PROCEDURE [dbo].[DeleteReferral]      
 ...
 @CurrentDateTime DATETIME,    
   ...
   @ServiceTypeID NVARCHAR(10) = NULL         
AS      
BEGIN          
 ...
 IF(@IsShowList=1)      
 BEGIN      
  EXEC GetReferralList @AssigneeID, @ClientName,@PayorID,@NotifyCaseManagerID,@ChecklistID,@ClinicalReviewID,@CaseManagerID,@ServiceID,@AgencyID,@AgencyLocationID,@ReferralStatusID,@IsSaveAsDraft,@AHCCCSID,@CISNumber,@IsDeleted, @SortExpression, @SortType
  
, @FromIndex, @PageSize  ,@DDType_PatientSystemStatus    
 END      
END  