--  EXEC ExportReconcileList    @PayorID = '3', @ServiceStartDate = '2017/05/01', @ServiceEndDate = '2017/05/31', @ClaimStatusCodeID = '0', @ReconcileStatus = 'Denied', @Get835ProcessedOnly = '0', @Upload835FileID = '0', @ServiceID = '-1', @ClaimAdjustmentTypeID = '-1', @NoteID = '', @PayorClaimNumber = '', @SortExpression = 'ClientName', @SortType = 'ASC', @FromIndex = '0', @PageSize = '0'
CREATE Procedure [dbo].[ExportReconcileList]   
@PayorID bigint =0,        
