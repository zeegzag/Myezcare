...
--EXEC GetReferralDocumentListNew @UserType = '1', @ReferralID = '24243', @ComplianceID = '10227', @Name = '', @SearchInDate = 'Added', @KindOfDocument = '', @SearchType = 'Directory', @SortExpression = 'CreatedDate', @SortType = 'Desc', @FromIndex = '1',@PageSize = '50'    
...
INSERT INTO @TempTable(ReferralDocumentID,ComplianceID,Name,FilePath,KindOfDocument,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,ExpirationDate)                
...
UpdatedBy=dbo.GetGeneralNameFormat(EU.FirstName,EU.LastName),RD.UpdatedDate,ExpirationDate                
...
--          FOR XML PATH('')), 1, 2, ''),                
CreatedBy=Dbo.GetGeneralNameFormat(E.FirstName,E.LastName),EBFM.CreatedDate,UpdatedBy=Dbo.GetGeneralNameFormat(EU.FirstName,EU.LastName),EBFM.UpdatedDate        
...
WHERE (ReferralID=@ReferralID OR EBFM.EmployeeID=@EmployeeID) AND EBFM.IsDeleted=0 --AND SubSectionID=@ComplianceID                
