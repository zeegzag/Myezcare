--EXEC HC_GenerateEdiFileModel @BatchID = '33', @PayorID = '1', @ReferralID = '12', @fileType = 'CMS1500', @BatchTypeID = '1', @StartDate = '', @EndDate = '', @ServiceCodeIDs = '', @ClientName = ''

-- exec [dbo].[HC_GenerateEdiFileModel] 17,1,8,'CMS1500',1,null,null,'',''
...
SET @MedicaidType = 'Medicaid'                 
 ...
 R.Dob,R.Gender,RPM.BeneficiaryNumber, R.AHCCCSID,
...
BEGIN                
 ...
 dbo.GetGeneralNameFormat(R.FirstName, R.LastName) AS PatientName,             
 R.Dob,R.Gender,RPM.BeneficiaryNumber,R.AHCCCSID ,R.CISNumber,MedicalRecordNumber=R.AHCCCSID, R.PolicyNumber,               
 AdmissionDate=R.CreatedDate, StrAdmissionDate=CONVERT(varchar,R.CreatedDate, 1),                          
 SubscriberID=R.AHCCCSID, ClaimSubmitterIdentifier=R.AHCCCSID, PatientAccountNumber=R.AHCCCSID,              
 C.ContactID,C.Address,C.City,C.State,C.ZipCode,C.Phone1,              
 ModifierIDs=COALESCE(SC.ModifierID,''),ModifierName = CASE WHEN (SC.ModifierID IS NULL OR SC.ModifierID ='') THEN '' ELSE                        
