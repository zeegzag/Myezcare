...
AS                                  
BEGIN                      
  SELECT PatientName=dbo.GetGeneralNameFormat(r.FirstName,r.LastName),HHA_PCA_Name=dbo.GetGeneralNameFormat(e.FirstName,e.LastName),sm.StartDate,DATENAME(dw,sm.StartDate) as DayOfWeek,ev.EmployeeVisitID,        
