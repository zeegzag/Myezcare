...
BEGIN      
  ...
  SELECT R.ReferralID, R.FirstName,R.LastName, R.Dob, SM.ScheduleID, SM.ScheduleStatusID, SM.IsPatientAttendedSchedule,    
SM.AbsentReason,                     
 ScheduleStartDate= SM.StartDate,ScheduleEndDate=  SM.StartDate, F.FacilityName, EV.ClockInTime, EV.ClockOutTime, EV.EmployeeVisitID,      
  ...
  WHERE SM.IsDeleted=0 AND R.IsDeleted=0 AND SM.FacilityID > 0 AND SM.PayorID > 0 --AND SM.ScheduleStatusID=2      
