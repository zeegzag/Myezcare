 ...
 (           
  ...
  (          
   SELECT ROW_NUMBER() OVER (ORDER BY           
    ...
    A.AgencyID,AgencyType,TIN,EIN,Mobile,NickName,ShortName,R.RegionName,A.RegionID,ContactName,A.Email,Phone,Address,A.Fax,City,StateCode,ZipCode,A.IsDeleted            
   FROM   Agencies A         
