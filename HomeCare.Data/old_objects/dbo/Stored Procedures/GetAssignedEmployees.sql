...
CREATE PROCEDURE [dbo].[GetAssignedEmployees]    
...
SELECT DISTINCT E.EmployeeID,EmployeeName=dbo.GetGeneralNameFormat(E.FirstName,E.LastName),E.LastName, E.MobileNumber  
