...
DECLARE @TempTable Table(              
 ...
 BEGIN          
   ...
   (ReferralID,StartDate,EndDate,ScheduleStatusID,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,SystemID,IsDeleted,FacilityID,ReferralTSDateID,PayorID,CareTypeId,ReferralBillingAuthorizationID)  
 ...
 BEGIN          
  ...
  INSERT INTO ScheduleMasters(ReferralID,StartDate,EndDate,ScheduleStatusID,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,SystemID,IsDeleted,FacilityID,ReferralTSDateID,PayorID,CareTypeId,ReferralBillingAuthorizationID)    
  OUTPUT inserted.ScheduleID,inserted.StartDate INTO @Output 
