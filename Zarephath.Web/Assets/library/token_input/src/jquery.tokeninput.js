...
; (function ($) {
    ...
    $.TokenList = function (input, url_or_data, settings) {
        ...
        var input_box = $("<input class='" + $(input).data("settings").customClass + "' type=\"text\" autocomplete=\"off\" autocapitalize=\"off\"/>")
            .css({
                outline: "none"
            })
            ...
            .focus(function () {
                if ($(input).data("settings").disabled) {
                    ...
                    var minChars = $(input).data("settings").minChars;
                    if (minChars == 0)
                        do_search();
                ...
                switch (event.keyCode) {
                    ...
                    //case KEY.COMMA:
                       if (selected_dropdown_item) {
                        ...
                        return false;
                    case KEY.COMMA:
                        //TODO: commenting this code to allow comma in search it will not work in multi select
                        //if (selected_dropdown_item) {
                        //    add_token($(selected_dropdown_item).data("tokeninput"));
                        //    hiddenInput.change();
                        //} else {
        ...
        function old_show_dropdown() {
            var minwidth = 'auto';
            if ($(token_list) != undefined)
                minwidth = $(token_list).width();
        ...
        function show_dropdown() {
            ...
            if (availableSpace >= 200) {
                ...
                if ((bodyHeight + bodyTop) < dropdownPosition) {
                    ...
                    bottom = (bodyTop + bodyHeight) - ($(token_list).offset().top);
                }
