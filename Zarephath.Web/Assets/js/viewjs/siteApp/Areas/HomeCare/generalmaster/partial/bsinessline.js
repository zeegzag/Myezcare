...
controllers.AddBusinessLineController = function ($scope, $http, $timeout, $window, $filter) {
    custModel = $scope;

    $scope.newInstance = function () {
        return $.parseJSON($("#hdnBussinessLineControllerModel").val());
    };

    $scope.DDMasterList = [];
    $scope.SelectedDDMasterIds = [];
    $scope.SelectAllCheckbox = false;
    $scope.DDMasterModel = $.parseJSON($("#hdnBussinessLineControllerModel").val());
...
controllers.AddBusinessLineController.$inject = ['$scope', '$http', '$timeout', '$window', '$filter'];
