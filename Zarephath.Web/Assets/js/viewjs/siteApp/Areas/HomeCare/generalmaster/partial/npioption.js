...
controllers.AddNPIOptionController = function ($scope, $http, $timeout, $window, $filter) {
    custModel = $scope;

    $scope.newInstance = function () {
        return $.parseJSON($("#hdnNPIOptionModel").val());
    };

    $scope.DDMasterList = [];
    $scope.SelectedDDMasterIds = [];
    $scope.SelectAllCheckbox = false;
    $scope.DDMasterModel = $.parseJSON($("#hdnNPIOptionModel").val());
...
controllers.AddNPIOptionController.$inject = ['$scope', '$http', '$timeout', '$window', '$filter'];
