...
controllers.ScheduleAssignmentController = function ($scope, $http, $compile, $timeout, $filter) {
    ...
    $scope.SchEmployeeDetailUrl = HomeCareSiteUrl.PrivateDuty_GetSchEmployeeDetailForPopupURL;
    ...
    $scope.GetSchEmployeeList = function (isSearchDataMappingRequire) {
        ...
        AngularAjaxCall($http, HomeCareSiteUrl.PrivateDuty_GetSchEmployeeListForScheduleURL, jsonData, "Post", "json", "application/json", false).success(function (response) {
    ...
    $scope.UpdateScheduleStatus = function (scheduleModel) {
        ...
        if (isValid) {
            ...
            AngularAjaxCall($http, HomeCareSiteUrl.PrivateDuty_UpdateScheduleMasterURL, jsonData, "Post", "json", "application/json").success(function (response) {
                ShowMessages(response);
                if (response.IsSuccess) {
                    if (!$scope.$root.$$phase) {
                        $scope.$apply();
    ...
    $scope.RefetchResources = function (calendarObj,callback) {
        ...
        AngularAjaxCall($http, HomeCareSiteUrl.PrivateDuty_GetReferralForSchedulingURL, data, "Post", "json", "application/json", false).success(function (response) {
            if (response.IsSuccess) {
    ...
    $scope.GetScheduleList = function (calendarObj, start, end, callback) {
        ...
        if ($scope.SelectedReferralList.length > 0) {
            ...
            AngularAjaxCall($http, HomeCareSiteUrl.PrivateDuty_GetScheduleListByReferralsURL, jsonData, "Post", "json", "application/json", $scope.ShowLoadOnCalenderLoad).success(function(response) {
    ...
    $scope.SaveSchedule = function (newSchedule, isEditing, successCallback, errorCallback) {
        ...
        AngularAjaxCall($http, HomeCareSiteUrl.PrivateDuty_SaveScheduleFromCalenderURL, jsonData, "Post", "json", "application/json", false).success(function (response) {
            if (response.IsSuccess) {
    ...
    $scope.RemoveSchedule = function (calendarObj, event, popOverFunctions) {
        ...
        bootboxDialog(function (result) {
            if (result) {
                ...
                AngularAjaxCall($http, HomeCareSiteUrl.PrivateDuty_DeleteScheduleFromCalenderURL, jsonData, "Post", "json", "application/json").success(function (response) {
    ...
    $scope.ResourceRender = function (calendarObj, resourceObj, labelTds, bodyTds) {
        ...
        resourceObj.Url = HomeCareSiteUrl.PrivateDuty_GetEmployeeMatchingPreferencesURL;
