...
controllers.ReferralDocumentController = function ($scope, $http, $window, $timeout, $filter) {
    ...
    $scope.GetSectionList = function () {
        var jsonData = angular.toJson({ EncryptedReferralID: $scope.EncryptedReferralID, UserType: $scope.UserType });
    ...
    $scope.GetSubSectionList = function (data, id) {
        ...
        $scope.ShowFrame = false;
        var jsonData = angular.toJson({ EncryptedReferralID: $scope.EncryptedReferralID, id: data.ComplianceID, userType: $scope.UserType });
