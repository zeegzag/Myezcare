...
controllers.Reconcile835Controller = function ($scope, $http, $timeout) {
    ...
    $scope.ReconcileListURL = SiteUrl.ReconcileListURL;
    ...
    $scope.GetReconcile835List = function (isSearchDataMappingRequire) {
        ...
        AngularAjaxCall($http, SiteUrl.ReconcileListURL, jsonData, "Post", "json", "application/json", false).success(function (response) {
    ...
    $scope.GetBatchNoteDetails = function (item, trElem) {
        ...
        if (item.AHList == undefined) {
            ...
            AngularAjaxCall($http, SiteUrl.GetChildReconcileListUrl, jsonData, "Post", "json", "application/json").success(function (response) {
                if (response.IsSuccess) {
    ...
    $scope.MarkNoteAsLatest = function (data, item) {
        ...
        AngularAjaxCall($http, SiteUrl.MarkNoteAsLatest01Url, jsonData, "Post", "json", "application/json").success(function (response) {
            if (response.IsSuccess) {
    ...
    $scope.ExportReconcileList = function () {
        ...
        var jsonData = $scope.SetPostData($scope.Reconcile835ListPager.currentPage);
        AngularAjaxCall($http, SiteUrl.GetExportReconcileListURL, jsonData, "Post", "json", "application/json", false).success(function (response) {
            if (response.IsSuccess) {
