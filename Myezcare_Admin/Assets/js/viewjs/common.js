...
function AngularAjaxCall($angularHttpObejct, url, postData, httpMethod, callDataType, contentType, showLoading) {
...
function CrossDomainAngularAjaxCall(url, postData, httpMethod, callDataType, contentType, withCredentials,showLoading) {
...
function createNotification(message, link) {
    var options = {
        ...
        icon: window.LiveSiteURL + '/assets/images/logo-blue@2x.png',
        dir: 'ltr'
    };
