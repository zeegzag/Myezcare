...
function EmptimeslotHeight() {
    var EmpHeaderheight = $('.page-header').outerHeight();
    var EmpWindowheight = $(window).outerHeight();
    var EmpTimetableHeight = $(window).outerHeight() - $('.page-header').outerHeight() - 130;
    $(".emp_timeslotstblheight").css("height", EmpTimetableHeight + "px");
}
