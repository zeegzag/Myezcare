...
namespace OopFactory.X12.Validation
{
    ...
    public class ProfessionalClaimAcknowledgmentService : X12AcknowledgmentService
    {
        public ProfessionalClaimAcknowledgmentService()
            : base(new ProfessionalClaimSpecificationFinder())
        {
        }
