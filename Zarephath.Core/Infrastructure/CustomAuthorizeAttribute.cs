...
//using Snaptym.Core.Models.Entity;
//using Snaptym.Core.Models.ViewModel;
...
namespace Zarephath.Core.Infrastructure
{
    public class CustomAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            //baseDataProvider.GetOrganizationConnectionString(SessionHelper.DomainName);
            ...
            else
            {
                ...
                if (SessionHelper.LoggedInID > 0)
                {
                    ...
                    {
                        Common.AceessDeniedErrorHistoryLogs("permission", SessionHelper.DomainName, SessionHelper.LoggedInID);
