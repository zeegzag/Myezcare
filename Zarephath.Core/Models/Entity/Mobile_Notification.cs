...
namespace Zarephath.Core.Models.Entity
{
    ...
    public class Mobile_Notification
    {
        ...
        public enum NotificationTypes
        {
            ...
            PatientResignature,
            [Display(ResourceType = typeof(Resource), Name = "PatientOnHoldNotification")]
            PatientOnHoldNotification,
            [Display(ResourceType = typeof(Resource), Name = "ChecklistNotification")]
