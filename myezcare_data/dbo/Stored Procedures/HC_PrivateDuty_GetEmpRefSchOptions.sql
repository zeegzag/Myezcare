...
SELECT ReferralID,RefPreferenceID,EmpPreferenceID,EmployeeID,FirstName,LastName,IsDeleted,OrderRank,PreferencesMatchPercent,SkillsMatchPercent,EmpLatLong,KeyType,Email,PhoneWork     --EmployeeTimeSlotDetailIDs, Frequency, StartTime, EndTime,ETMStartDate,ETMEndDate            
 FROM (            
