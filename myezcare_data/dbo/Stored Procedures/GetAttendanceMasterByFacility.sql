...
BEGIN   
 ...
 select am.AttendanceMasterID,am.ScheduleMasterID,am.ReferralID,am.StartDate,am.EndDate,am.Comment,am.AttendanceStatus,r.LastName+', '+r.FirstName as Name,  
 dbo.GetAge(r.Dob) as Age,am.UpdatedBy,am.UpdatedDate,e.LastName+', '+e.FirstName as UpdatedByName, 
 ...
 where  
 --((@ClientName IS NULL OR LEN(@ClientName)=0) OR r.LastName+' '+r.FirstName LIKE '%' + @ClientName + '%')    
