...
CREATE Procedure [dbo].[HC_GetReconcileBatchNoteDetails]  
...
Select     
R.ReferralID,ClientName=R.LastName+', '+R.FirstName,R.FirstName,R.LastName,C.Address,C.City,C.State,C.ZipCode, R.Gender, ClientDob=CONVERT(VARCHAR(10), R.Dob, 101),R.AHCCCSID,R.CISNumber,    
