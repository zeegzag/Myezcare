CREATE PROCEDURE [dbo].[GetUpload835FileList]                            
...
;WITH CTEEdiFileLog AS                        
 ...
 CASE WHEN @SortType = 'DESC' THEN CASE WHEN @SortExpression = 'FileSize' THEN  cast(FileSize as decimal)     END END DESC,        
   ...
   UF.Upload835FileID,UF.PayorID,P.ShortName AS PayorName,UF.BatchID,UF.Comment, UF.FileName, UF.FilePath,UF.IsDeleted,UF.IsProcessed, UF.Upload835FileProcessStatus,UF.FileSize,UF.CreatedDate as AddedDate,EMP.FirstName,EMP.LastName,
   UF.ReadableFilePath
