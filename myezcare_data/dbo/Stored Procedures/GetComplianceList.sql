--EXEC GetComplianceList @IsDeleted = '0', @UserType = '-1', @DocumentationType = '-1', @IsTimeBased = '-1', @Type = '', @SortExpression = 'ComplianceID', @SortType = 'DESC', @FromIndex = '1', @PageSize = '50'    
