	...
	SELECT *,COUNT(t1.NoteID) OVER() AS Count FROM 
		...
		* FROM (
		SELECT DISTINCT n.NoteID,--BN.BatchID,case when B.IsSent=1 then 1 else 0 end as IsSent,
		 ...
		 n.SystemID,n.ZarephathService,n.PayorShortName,n.UnitType,n.UpdatedBy,n.UpdatedDate,pos.PosName,m.ModifierName,n.IsDeleted,CASE when n.CreatedBy > 0 then e.LastName+', '+e.FirstName else n.Source END as Name,
