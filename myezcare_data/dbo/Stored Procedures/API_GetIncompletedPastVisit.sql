...
BEGIN            
   ...
   SELECT DISTINCT sm.ScheduleID,EmployeeName = dbo.GetGeneralNameFormat(e.FirstName,e.LastName),e.FirstName,ss.ScheduleStatusName,ev.ClockInTime,ev.ClockOutTime,sm.StartDate,sm.EndDate,sm.ReferralID,sm.EmployeeID,          
