...
;WITH CTEReferralInternalMessage AS                    
 (                     
  ...
  (                    
   ...
   t.* FROM                    
   (        SELECT DISTINCT REF.ReferralID, REF.ClientID,REF.CISNumber,REF.AHCCCSID,REF.FirstName,REF.LastName,Gender,dbo.GetAge(REF.Dob) as Age ,                
  RIM.ReferralInternalMessageID,RIM.Note,RIM.CreatedDate,RIM.IsResolved,EMP1.LastName + ', ' + EMP1.FirstName AS CreatedByName,          
