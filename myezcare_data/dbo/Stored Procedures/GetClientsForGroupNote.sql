...
select distinct top (@PageSize) R.ReferralID,R.LastName+', '+ R.FirstName as Name,R.AHCCCSID,R.CISNumber,C.Phone1,C.Address,RPM.PayorID,P.ShortName as PayorName,        
