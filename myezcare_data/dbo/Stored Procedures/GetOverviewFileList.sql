...
PRINT 'Non SENT'+ @NonSENTBatches
		...
		SELECT 
		R.ReferralID,BN.NoteID,BN.BatchID,ClientName=R.LastName+', '+R.FirstName,R.FirstName,R.LastName,C.Address,C.City,C.State,C.ZipCode, R.Gender, ClientDob=CONVERT(VARCHAR(10), R.Dob, 101),R.AHCCCSID,R.CISNumber,            
