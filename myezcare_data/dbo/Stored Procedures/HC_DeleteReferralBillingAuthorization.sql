...
CREATE PROCEDURE [dbo].[HC_DeleteReferralBillingAuthorization]  
...
BEGIN                                    
 ...
 IF(@IsShowList=1)                                
 BEGIN                                
  EXEC HC_GetReferralBillingAuthorizationList @ReferralID,@PayorID,@AuthorizationCode,@IsDeleted,@AuthType,@StartDate,@EndDate,  
