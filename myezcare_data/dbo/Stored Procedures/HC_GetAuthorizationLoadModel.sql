...
BEGIN                  
 ...
 WHERE RPM.ReferralID=@ReferralID AND RPM.IsActive=1 AND GETDATE() BETWEEN RPM.PayorEffectiveDate AND ISNULL(RPM.PayorEffectiveEndDate,@InfinateDate) AND RPM.IsDeleted=0
