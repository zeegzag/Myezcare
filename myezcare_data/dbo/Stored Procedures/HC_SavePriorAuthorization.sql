CREATE PROCEDURE [dbo].[HC_SavePriorAuthorization]
...
AND ReferralID=@ReferralID --AND IsDeleted=0 --AND AuthorizationCode=@AuthorizationCode         
...
BEGIN TRANSACTION trans                                  
 ...
 BEGIN                
  INSERT INTO ReferralBillingAuthorizations (ReferralID,Type,AuthorizationCode,PayorID,StartDate,EndDate,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy,SystemID)        
  VALUES(@ReferralID,@Type,@AuthorizationCode,@PayorID,@StartDate,@EndDate,GETUTCDATE(),@loggedInID,GETUTCDATE(),@loggedInID,@SystemID)                
