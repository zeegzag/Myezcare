...
select ROW_NUMBER() OVER(ORDER BY  a.EmployeeVisitID ASC) AS Id, a.EmployeeVisitID into #temp from EmployeeVisitNotes a
...
Begin
	...
	EXEC API_AddNote @employeevisitid, 0, null, 0
	set @Id = (@Id - 1)
End
