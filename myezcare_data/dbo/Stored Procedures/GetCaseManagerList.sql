...
BEGIN  
 ...
 (   
   ...
   * FROM (
   SELECT CM.CaseManagerID, CM.LastName + ', ' +CM.FirstName AS Name, CM.Email,CM.Phone,  
   ...
   GROUP BY CM.CaseManagerID, CM.LastName , CM.FirstName, CM.Email,CM.Phone, A.NickName , CM.IsDeleted
