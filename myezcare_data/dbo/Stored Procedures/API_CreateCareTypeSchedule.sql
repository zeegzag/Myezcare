...
IF(@CareTypeTimeSlotID>0)          
 BEGIN          
  ...
  CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,SystemID,IsDeleted,PayorID) VALUES          
  (@ReferralID,@EmployeeID,@CareTypeTimeSlotID,@ServerCurrentDate--+CAST('00:01:00' AS DATETIME)  
  ,@ServerCurrentDate+CAST('23:59:00' AS DATETIME),    
  2,@EmployeeID,@ServerCurrentDate,@EmployeeID,@ServerCurrentDate,@SystemID,0,@PayorID)
          
  SELECT @@IDENTITY AS TablePrimaryId,1 AS TransactionResultId          
 END          
ELSE          
 BEGIN          
  ...
  INSERT INTO ScheduleMasters (ReferralID,EmployeeID,CareTypeTimeSlotID,StartDate,EndDate,ScheduleStatusID,        
  CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,SystemID,IsDeleted,PayorID) VALUES          
  (@ReferralID,@EmployeeID,@@IDENTITY,@ServerCurrentDate--+CAST('00:01:00' AS DATETIME)  
  ,@ServerCurrentDate+CAST('23:59:00' AS DATETIME),    
  2,@EmployeeID,@ServerCurrentDate,@EmployeeID,@ServerCurrentDate,@SystemID,0,@PayorID)
