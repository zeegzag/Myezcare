...
BEGIN                  
  ...
  SELECT evn.AlertComment,e.MobileNumber,EmployeeName=dbo.GetGeneralNameFormat(es.FirstName,es.LastName),PatientName=dbo.GetGeneralNameFormat(r.FirstName,r.LastName)    
 ...
 WHERE e.RoleID=1 AND e.MobileNumber Is not null    
