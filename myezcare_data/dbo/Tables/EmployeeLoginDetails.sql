...
GO
CREATE TRIGGER [dbo].[tr_EmployeeLoginDetails_Deleted] ON [dbo].[EmployeeLoginDetails]
FOR DELETE AS 
...
GO
DISABLE TRIGGER [dbo].[tr_EmployeeLoginDetails_Deleted]
    ON [dbo].[EmployeeLoginDetails];
...
GO
DISABLE TRIGGER [dbo].[tr_EmployeeLoginDetails_Updated]
    ON [dbo].[EmployeeLoginDetails];
