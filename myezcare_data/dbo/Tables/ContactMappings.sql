...
GO
CREATE TRIGGER [dbo].[tr_ContactMappings_Deleted] ON [dbo].[ContactMappings]
FOR DELETE AS 
...
GO
DISABLE TRIGGER [dbo].[tr_ContactMappings_Deleted]
    ON [dbo].[ContactMappings];
...
GO
DISABLE TRIGGER [dbo].[tr_ContactMappings_Updated]
    ON [dbo].[ContactMappings];
