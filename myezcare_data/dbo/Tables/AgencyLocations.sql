...
GO
CREATE TRIGGER [dbo].[tr_AgencyLocations_Deleted] ON [dbo].[AgencyLocations]
FOR DELETE AS 
...
ZipCode,
AgencyID, 
'D',GETUTCDATE(),IsDeleted FROM deleted

GO
DISABLE TRIGGER [dbo].[tr_AgencyLocations_Deleted]
    ON [dbo].[AgencyLocations];
...
GO
DISABLE TRIGGER [dbo].[tr_AgencyLocations_Updated]
    ON [dbo].[AgencyLocations];
