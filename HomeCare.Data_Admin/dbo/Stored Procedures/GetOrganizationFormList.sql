...
CREATE PROCEDURE [dbo].[GetOrganizationFormList]  
...
;WITH CTEFormList AS                
 ...
 EF.*, FormCategory=EC.Name  
 FROM  OrganizationForms OFM
 INNER JOIN EBForms EF  ON EF.EBFormID=OFM.EBFormID AND OFM.OrganizationID=@OrganizationID
